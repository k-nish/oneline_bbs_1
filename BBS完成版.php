<?php
  ...
  //データベースに接続
  // ステップ1.db接続
  $dsn = 'mysql:dbname=LAA0700028-onelinebbs;host=mysql107.phy.lolipop.lan';
...
<!--                   <li class="hidden">
  ...
  <div class="container">
    ...
    <form action="BBS完成版.php" method="post">
      ...
      <div class="col-md-8 content-margin-top">
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                <a href="BBS完成版.php?action=edit&id=<?php echo $post['id'];?>">
                ...
                <div class="timeline-label">
                    ...
                    <a href="BBS完成版.php?action=delete&id=<?php echo $post['id'];?>"><i class="fa fa-trash fa-lg"></i></a>
                </div>
            </div>
