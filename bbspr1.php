...
try{
  ...
  $editcomment = '';
    ...
    if(isset($_GET['action'])&& ($_GET['action'] == 'edit')){
        ...
        //nickname,comment,idに値を代入
        $id = $req['id'];
        $editname = $req['nickname'];
        $editcomment = $req['comment'];
        //echo $editname;
        }
        //deleteのget送信が行われたらコメント削除処理を実行
    ...
    // echo $rec['comment'];
    // echo $rec['created'];
    //header('Location: http://=localhost/oneline_bbs_1/bbspr1.php');
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
          ...
          <div class="navbar-header page-scroll">
              ...
              <a class="navbar-brand" href="#page-top"><span class="strong-title"><i class="fa fa-book"></i> サンフレンド実況掲示板 ！</span></a>
          </div>
...
<!--                   <li class="hidden">
  ...
  <div class="container">
    ...
    <form action="bbspr1.php" method="post">
      ...
      <div class="col-md-8 content-margin-top">
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                <a href="bbspr1.php?action=edit&id=<?php echo $post['id'];?>">
                ...
                <div class="timeline-label">
                    ...
                    <a href="bbspr1.php?action=delete&id=<?php echo $post['id']; ?>"><i class="fa fa-trash-o"></i></a>
                </div>
            </div>
...
<?php }catch(Exception $e){
  echo "サーバーの障害によりページを開くことができません。しばらくお待ち下さい。";
}
?>
