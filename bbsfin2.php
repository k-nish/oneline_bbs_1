...
<!--                   <li class="hidden">
  ...
  <div class="container">
    ...
    <form action="bbsfin2.php" method="post">
      ...
      <div class="col-md-8 content-margin-top">
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                <a href="bbsfin2.php?action=edit&id=<?php echo $post['id'];?>">
                ...
                <div class="timeline-label">
                    ...
                    <a href="bbsfin2.php?action=delete&id=<?php echo $post['id'];?>"><i class="fa fa-trash fa-lg"></i></a>
                </div>
            </div>
